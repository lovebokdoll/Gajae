      ...
      <div className="filter-group" style={{ margin: '30px 0px 0px 50px', width: '200px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="수영장"
            checked={filters.find((filter) => filter.name === '수영장').value}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="노래방"
            checked={filters.find((filter) => filter.name === '노래방').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="편의점"
            checked={filters.find((filter) => filter.name === '편의점').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="스파"
            checked={filters.find((filter) => filter.name === '스파').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="동물출입가능"
            checked={filters.find((filter) => filter.name === '동물출입가능').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="바베큐장"
            checked={filters.find((filter) => filter.name === '바베큐장').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="주차장"
            checked={filters.find((filter) => filter.name === '주차장').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="무료와이파이"
            checked={filters.find((filter) => filter.name === '무료와이파이').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="금연객실"
            checked={filters.find((filter) => filter.name === '금연객실').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <input
            type="checkbox"
            name="넷플릭스"
            checked={filters.find((filter) => filter.name === '넷플릭스').value}
            onChange={handleCheckboxChange}
          />
        </div>
        ...
        <hr />
        <label>
          <div className="filter">호텔 유형 </div>{' '}
        </label>
        <hr />
