...
const HostZipCode = ({ onZipcodeChange, onAddrChange, post, setPost, setHostMapx, setHostMapy, p_mapy, p_mapx }) => {
      ...
      <ContainerDiv>
        <FormDiv>
          <div style={{ width: '200px' }}>
            ...
            />
            <button onClick={clickAddr} type="button" class="btn btn-warning" style={{ marginTop: '10%' }}>
              주소검색하기
            </button>
          </div>
        </FormDiv>
