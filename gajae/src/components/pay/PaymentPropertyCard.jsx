...
const PaymentPropertyCard = () => {
  ...
  return (
    <>
      <div className="card" style={{ width: '60rem', height: '17rem', backgroundColor: 'rgb(214,230,245)' }}>
        <div className="card-body">
          <div style={{ width: '928px', height: '222px', border: '1px solid black', display: 'flex', alignItems: 'center' }}>
