          ...
          <ResWrapper>
            <div className="hotelInfoFirst">
              <div className="hotelInfoDiv">
                <span>
                  <img
                    className="resHotelImage"
                    src={reservation.P_PHOTO}
                    alt="placeholder_image"
                  />
                </span>
                <div
                  className="hotelName"
                  style={{ width: "600px", fontSize: "0.9em" }}
                >
                  <FontAwesomeIcon icon="fa-solid fa-house" />
                  <span
                    className="myResInfoPtitle"
                    style={{ margin: "0px 0px 0px 0px", fontSize: "1.1em" }}
                  >
                    {" "}
                    &nbsp;{reservation.P_TITLE}
                    &nbsp;{" "}
                    {Array.from({ length: reservation.P_STAR }, (_, index) => (
                      <FontAwesomeIcon
                        style={{ fontSize: "0.8em", color: "yellow" }}
                        icon={faStar}
                        key={index}
                      />
                    ))}
                  ...
                  <p
                    className="myResInfoAddress"
                    style={{ margin: "0px 0px 1px 0px", fontSize: "0.75em" }}
                  >
                    주소:&nbsp;{reservation.P_ADDRESS}, 대한민국
                  </p>
                  <p
                    className="myResInfoTel"
                    style={{ margin: "0px 0px 1px 0px", fontSize: "0.75em" }}
                  >
                    전화:&nbsp;{reservation.P_TEL}
                  </p>
                  <p
                    className="myResInfoGps"
                    style={{ margin: "0px 0px 0px 0px", fontSize: "0.75em" }}
                  >
                    GPS 좌표계:&nbsp;{gps}
                  </p>
                  <p
                    className="myResInfoDateS"
                    style={{ margin: "0px 0px 1px 0px", fontSize: "0.75em" }}
                  >
                    체크인: {reservation.R_START_DATE}&nbsp;({startDayOfWeek}
                    )&nbsp;{reservation.P_CHECKIN}부터 &nbsp;-&nbsp;체크아웃:{" "}
                    {reservation.R_END_DATE}&nbsp;({endDayOfWeek})&nbsp;
              ...
              <div>
                <span style={{ fontSize: "0.35em" }}>
                  표시된 최종 요금은 숙소 측에 지불할 요금입니다. Gajae.com은
                  예약, 행정 및 기타 수수료를 고객님께 청구하지 않습니다.
                  신용카드 회사에서 해외 사용 수수료를 부과할 수 있습니다.
                </span>
                <br />
                <hr
                  style={{ margin: "0px 5px 0px 0px", marginBottom: "0px" }}
                />
                <span style={{ fontSize: "0.35em" }}>
                  결제 관련 정보 {reservation.P_TITLE}에서 요금 결제 일체를
                  담당합니다. 이 숙박 업체에서 사용 가능한 결제 수단:&nbsp;
                ...
                <span style={{ fontSize: "0.35em" }}>
                  {" "}
                  통화 및 환율 정보 {reservation.P_TITLE}에서 결제일 시점의
                  환율에 따라 {reservation.CURRENCY} 통화로 결제하시게 됩니다.
                  현재 {reservation.CURRENCY}의 통화로 표기된 금액은 금일{" "}
                  {reservation.CURRENCY} 환율을 바탕으로 추산된 수치입니다.{" "}
                </span>
              </div>
            </div>
          </ResWrapper>
