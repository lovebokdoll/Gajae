            ...
            <div className="hotelInfoFirst">
              <div className="hotelInfoDiv">
                ...
                <div className="hotelName" style={{ width: '600px', fontSize: '0.9em' }}>
                  ...
                  <span className="myResInfoPtitle" style={{ margin: '0px 0px 0px 0px', fontSize: '1.1em' }}>
                    ...
                    <span className="resDateSpan" style={{ float: 'right', marginRight: '15px', fontSize: '0.9em' }}>
                      {' '}
                  ...
                  <p className="myResInfoAddress" style={{ margin: '0px 0px 1px 0px', fontSize: '0.75em' }}>
                    주소:&nbsp;{reservation.P_ADDRESS}, 대한민국
                  </p>
                  <p className="myResInfoTel" style={{ margin: '0px 0px 1px 0px', fontSize: '0.75em' }}>
                    전화:&nbsp;{reservation.P_TEL}
                  </p>
                  <p className="myResInfoGps" style={{ margin: '0px 0px 0px 0px', fontSize: '0.75em' }}>
                    GPS 좌표계:&nbsp;{gps}
                  </p>
                  <p className="myResInfoDateS" style={{ margin: '0px 0px 1px 0px', fontSize: '0.75em' }}>
                    체크인: {reservation.R_START_DATE}&nbsp;({startDayOfWeek})&nbsp;{reservation.P_CHECKIN}부터 &nbsp;-&nbsp;체크아웃:{' '}
                    {reservation.R_END_DATE}&nbsp;({endDayOfWeek})&nbsp;{reservation.P_CHECKOUT}까지
                  </p>
                  <p className="myResInfoDateS" style={{ margin: '0px 0px 1px 0px', fontSize: '0.75em' }}>
              ...
              <div className="resPrice1" style={{ marginTop: '5px', fontSize: '0.75em' }}>
                ...
                <span className="resPrice1Span" style={{ float: 'right', marginRight: '10px' }}>
                  {reservation.PAID_AMOUNT.toLocaleString()}&nbsp;({reservation.CURRENCY})
                </span>
              </div>
              ...
              <div className="resPrice2" style={{ fontSize: '0.75em' }}>
                ...
                <span className="expectedPrice" style={{ float: 'right', marginRight: '10px' }}>
                  예상요금&nbsp;{reservation.PAID_AMOUNT.toLocaleString()}&nbsp;({reservation.CURRENCY})
                </span>
              </div>{' '}
              ...
              <div>
                ...
                <span style={{ fontSize: '0.35em' }}>
                  결제 관련 정보 {reservation.P_TITLE}에서 요금 결제 일체를 담당합니다. 이 숙박 업체에서 사용 가능한 결제 수단:&nbsp;
