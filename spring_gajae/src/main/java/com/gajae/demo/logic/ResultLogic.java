...
public class ResultLogic {
    ...
    public List<Map<String, Object>> searchlist( Map<String, Object> pMap ) {
        ...
        log.info( "pMap = {}", pMap );
        List<Map<String, Object>> resultList = searchDao.searchlist( pMap );
    ...
    public List<Map<String, Object>> priceLow( Map<String, Object> pMap, String orderBy ) {
        ...
        List<Map<String, Object>> resultList = searchDao.priceLow( pMap, orderBy );
    ...
    public List<Map<String, Object>> priceHigh( Map<String, Object> pMap, String orderBy ) {
        ...
        log.info( "pMap = {}", pMap );
        log.info( "orderby = {}", orderBy );
        List<Map<String, Object>> resultList = searchDao.priceHigh( pMap, orderBy );
